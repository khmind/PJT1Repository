...
<head>
  ...
  <link rel="stylesheet" href="https://r.mobirisesite.com/418493/assets/css/mbr-additional.css?rnd=1714583083056" type="text/css">
	<style type="text/css">
		.footer2{position: absolute; bottom: 0;
		width: 100%}
	</style>  
</head>
<body>
...
<!-- footer시작 -->
<section data-bs-version="5.1" class="footer2 cid-ubxwylcscK"  id="footer-5-ubxwylcscK">
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 center mt-2 mb-3">
                <p class="mbr-fonts-style copyright mb-0 display-10">© 2024 Tasty Recipes. All Rights Stirred.</p>
            </div>
