		...
		<div class="container">
			<div class="navbar-brand">
				<a href="./main.jsp">
					...
					<span class="navbar-caption-wrap"><a class="navbar-caption text-black display-4" href="./main.jsp">맛있는 레시피</a></span>
				</a>
			</div>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav" data-app-modern-menu="true">
						...
						data-bs-auto-close="outside" aria-expanded="false">한식</a>
						</li>		
						<li class="nav-item">
							<a class="nav-link link text-black display-4" href="fr_recipelist_for.jsp" 
								data-bs-auto-close="outside" aria-expanded="false">양식</a>
						</li>
						<li class="nav-item">
							<a class="nav-link link text-black display-4" href="fr_recipelist_chn.jsp" 
								data-bs-auto-close="outside" aria-expanded="false">중식</a>
						</li>
						<li class="nav-item">
							<a class="nav-link link text-black display-4" href="fr_recipelist_jpn.jsp" 
						...
						<li class="nav-item">
							<a class="nav-link link text-black display-4" href="fr_announcement.jsp">공지사항</a>
						</li>
					</ul>
					<div >
