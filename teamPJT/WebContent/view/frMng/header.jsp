		...
		<div class="container">
			<div class="navbar-brand">
				<a href="./main.jsp">
					...
					<span class="navbar-caption-wrap"><a class="navbar-caption text-black display-4" >맛있는 레시피</span>
				</a>
			</div>
			<button class="navbar-toggler" type="button" data-toggle="collapse"
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav" data-app-modern-menu="true">
						<li class="nav-item"><a
							class="nav-link link text-black display-4" href="#"
							data-bs-auto-close="outside" aria-expanded="false">한식</a></li>
					</li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link link text-black display-4" href="#" 
                data-bs-auto-close="outside" aria-expanded="false">일식</a>
					...
					<li class="nav-item">
						<a class="nav-link link text-black display-4" href="#" aria-expanded="false">베이킹</a>
					</li>
					<li class="nav-item">
						<a class="nav-link link text-black display-4" href="#">간식</a>
					</li></ul>				
          ...
          <a class="btn btn-warning-outline display-4" href="../login.html">
            ...
            로그인<span class="mbri-로그인 mbr-iconfont mbr-iconfont-btn"></span></a></div>
			</div>
		</div>
	</nav>
</section>
