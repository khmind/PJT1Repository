        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					<br>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">관리자관리</h1>
                    ...
                    <div class="card shadow mb-4">					                    
						...
						<table class="table">
							...
							<tbody>
								<tr onClick="move()">					      
									<th class="th1" scope="row">1</th>
									<td class="th2" scope="row">홍길동</td>
									<td class="th3" scope="row">aaa@aaa.com</td>
									<td class="th4" scope="row">YYYY.MM.DD</td>
								</tr>
								<tr onClick="move()">					      
									<th class="th1" scope="row">1</th>
									<td class="th2" scope="row">홍길동</td>
